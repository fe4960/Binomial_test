...
my $pt_freq = $ARGV[0];;
 $pt_freq = $pt_freq *2;
my $output = "HGMD/data/power_test_pf_dom_$ARGV[0]"."_test_new_ground_truth_new_inbreeding_other_$F_factor"."_new1";
my $output1 = "HGMD/data/power_test_pf_dom_$ARGV[0]"."_test_new_ground_truth_new_value_inbreeding_other_$F_factor"."_new1";
...
sub bin_test {
my $R_script = "STGD/scripts/R_pt_AD_inbr_other$ARGV[0].R";
my $R_out = "STGD/scripts/R_pt_AD_inbr_other$ARGV[0].out";
