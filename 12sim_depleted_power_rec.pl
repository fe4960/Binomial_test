...
my $output = "HGMD/data/power_test_pf_$ARGV[0]"."_test_new_ground_truth_new_inbreeding_other_$F_factor"."_new1";
my $output1 = "HGMD/data/power_test_pf_$ARGV[0]"."_test_new_ground_truth_new_value_inbreeding_other_$F_factor"."_new1";
...
my @normal_freq = (0.0002, 0.00025, 0.0005, 0.001, 0.005,0.01);
print OUTPUT "AF\t";
print OUTPUT1 "AF\t";
	...
	for my $i (@normal_freq){  # allele freq
		 ...
		 print OUTPUT1 "$i\t";
		   ...
		   my $normal_freq = $i; 
                   ...
                   my $power = $n/50;
                   print OUTPUT "$power:$pt_freq_exp:$p_origin\t";
                   print OUTPUT1 "$power\t";
...
sub bin_test {
my $R_script = "STGD/scripts/R_pt_AR_inbr_other$ARGV[0].R";
my $R_out = "STGD/scripts/R_pt_AR_inbr_other$ARGV[0].out";
