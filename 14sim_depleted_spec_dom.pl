...
my $pt_freq = $ARGV[0]; # ac/(number of pt *2)
 $pt_freq = $pt_freq *2;
my $F_factor = 0.1;
my $output = "HGMD/data/power_test_pf_dom_$ARGV[0]"."_test_new_ground_truth_new_spec_inbreeding_other_$F_factor"."_new1";
my $output1 = "HGMD/data/power_test_pf_dom_$ARGV[0]"."_test_new_ground_truth_new_value_spec_inbreeding_other_$F_factor"."_new1";
...
sub bin_test {
my $R_script = "STGD/scripts/R_pt_AD_spec_inbr_other$ARGV[0].R";
my $R_out = "STGD/scripts/R_pt_AD_spec_inbr_other$ARGV[0].out";
