...
my $STGD = "HGMD/data/LRP5_Li_other7_organized.gz";
my $total = 96;
...
my @ac = split(/:/,$info1[10]);
my @af = split(/:/,$info1[30]);
my @an = split(/:/,$info1[20]);
...
#my $STGD = "STGD/data/total_variant_wes_raw_summary_rmCN_rmOutlier_chr1_sort.gz";
