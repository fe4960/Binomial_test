...
my $label = "conv";
#my @size = (50,80,100,120,200,250,300,400,500,600,700,800,900,1000,2000,3000,4000,5000,6000,7000,8000,9000,10000);
my @size = (50,80,100,120,200,250,300,400,500,600,700,800,900,1000);
my @normal_freq = (0.00001,0.00002,0.00005,0.0001,0.0005);

my $output1 = "HGMD/data/power_test_pf_dom_test_new_ground_truth_new_value"."_$label";
...
print OUTPUT1 "AF\t";
	...
	for my $normal_freq (@normal_freq){  # allele freq
		 print OUTPUT1 "$normal_freq\t";

             for my $s (@size){   # pt cohort aize
                   my $size = $s;
                   
                   my $power = binProb($size,$normal_freq,$dom_dis_freq,"dom_power");
                   print OUTPUT1 "$power\t";
               }
                   print OUTPUT1 "\n";
         }
...
$output1 = "HGMD/data/spec_test_pf_dom_test_new_ground_truth_new_value"."_$label";
open(OUTPUT1,">$output1");
print OUTPUT1 "AF\t";
	...
	for my $normal_freq (@normal_freq){  # allele freq
		 print OUTPUT1 "$normal_freq\t";
             ...
             for my $s (@size){   # pt cohort aize
                   ...
                   my $power = binProb($size,$normal_freq,$dom_dis_freq,"dom_spec");
                   print OUTPUT1 "$power\t";
               }
                   print OUTPUT1 "\n";
         }
...
$output1 = "HGMD/data/power_test_pf_rec_test_new_ground_truth_new_value"."_$label";
open(OUTPUT1,">$output1");
	...
	for my $normal_freq (@normal_freq){  # allele freq
		 print OUTPUT1 "$normal_freq\t";
             ...
             for my $s (@size){   # pt cohort aize
                   ...
                   my $power = binProb($size,$normal_freq,$rec_dis_freq,"rec_power");
                   print OUTPUT1 "$power\t";
               }
                   print OUTPUT1 "\n";
         }
...
$output1 = "HGMD/data/spec_test_pf_rec_test_new_ground_truth_new_value"."_$label";
open(OUTPUT1,">$output1");
print OUTPUT1 "AF\t";
	...
	for my $normal_freq (@normal_freq){  # allele freq
		 print OUTPUT1 "$normal_freq\t";
             ...
             for my $s (@size){   # pt cohort aize
                   ...
                   my $power = binProb($size,$normal_freq,$rec_dis_freq,"rec_spec");
                   print OUTPUT1 "$power\t";
               }
                   print OUTPUT1 "\n";
         }
