...
my $dom_normal_freq = 0.0001;
#my $rec_normal_freq = 0.0005;
my $rec_normal_freq = 0.001;
my $label = "conv";
my @size = (50,80,100,120,200,250,300,400,500,600,700,800,900,1000);
my @dis_freq = (0.005,0.001,0.0005,0.0002);

my $output1 = "HGMD/data/power_test_df_dom_test_new_ground_truth_new_value_$dom_normal_freq"."_$label";
...
$output1 = "HGMD/data/spec_test_df_dom_test_new_ground_truth_new_value_$dom_normal_freq"."_$label";
open(OUTPUT1,">$output1");
print OUTPUT1 "AF\t";
...
$output1 = "HGMD/data/power_test_df_rec_test_new_ground_truth_new_value_$rec_normal_freq"."_$label";
open(OUTPUT1,">$output1");
...
$output1 = "HGMD/data/spec_test_df_rec_test_new_ground_truth_new_value_$rec_normal_freq"."_$label";
open(OUTPUT1,">$output1");
print OUTPUT1 "AF\t";
...
#if($_[3] eq "dom_power"){
#print OUTFILE "factor=ifelse(pbinom\(b, size=$_[0], prob=$_[1]\*2\)<=0.05,1,0)\n";
#}elsif($_[3] eq "dom_spec"){
#print OUTFILE "factor=ifelse(pbinom\(b, size=$_[0], prob=$_[1]\*2\)>0.05,1,0)\n";
#}elsif($_[3] eq "rec_power"){
#print OUTFILE "factor=ifelse(pbinom\(b, size=$_[0], prob=$_[1]\)<=0.05,1,0)\n";
#}elsif($_[3] eq "rec_spec"){
#print OUTFILE "factor=ifelse(pbinom\(b, size=$_[0], prob=$_[1]\)>0.05,1,0)\n";
#}
