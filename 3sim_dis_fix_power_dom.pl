...
my $output = "HGMD/data/power_test_df_dom_$ARGV[0]"."_test_new_ground_truth_new";
my $output1 = "HGMD/data/power_test_df_dom_$ARGV[0]"."_test_new_ground_truth_new_value";
...
sub bin_test {
my $R_script = "STGD/scripts/R_dis_AD$ARGV[0].R";
my $R_out = "STGD/scripts/R_dis_AD$ARGV[0].out";
