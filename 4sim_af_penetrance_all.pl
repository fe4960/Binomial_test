...
#my $dom_dis_freq = 0.0005;
#my $rec_dis_freq = 0.00005;
my $label ="conv"; 
my @freq_factor = (0.1, 0.2, 0.5,0.7, 0.9, 1);
#my @normal_freq = (1-sqrt(1-$dom_dis_freq)/4/0.2, 1-sqrt(1-$dom_dis_freq)/4/0.5,1-sqrt(1-$dom_dis_freq)/4/0.8,1-sqrt(1-$dom_dis_freq)/4);
...
my $output1 = "HGMD/data/power_test_af_penet_dom_test_new_ground_truth_new_value_$normal_freq"."_$label";
...
$output1 = "HGMD/data/spec_test_af_penet_dom_test_new_ground_truth_new_value_$normal_freq"."_$label";
open(OUTPUT1,">$output1");
print OUTPUT1 "AF\t";
...
$output1 = "HGMD/data/power_test_af_penet_rec_test_new_ground_truth_new_value_$normal_freq"."_$label";
open(OUTPUT1,">$output1");
...
$output1 = "HGMD/data/spec_test_af_penet_rec_test_new_ground_truth_new_value_$normal_freq"."_$label";
open(OUTPUT1,">$output1");
print OUTPUT1 "AF\t";
