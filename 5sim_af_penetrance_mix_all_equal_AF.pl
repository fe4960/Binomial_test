...
my $a = (0.2+0.5+0.8+1);
my @normal_freq = ((1-sqrt(1-$dom_dis_freq))/$a/5, (1-sqrt(1-$dom_dis_freq))/$a/5, (1-sqrt(1-$dom_dis_freq))/$a/5,(1-sqrt(1-$dom_dis_freq))/$a/5);
...
@normal_freq = (sqrt($rec_dis_freq)/$a/5, sqrt($rec_dis_freq)/$a/5, sqrt($rec_dis_freq)/$a/5, sqrt($rec_dis_freq)/$a/5);
