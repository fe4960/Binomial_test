...
my $pt_freq = $ARGV[0]; # ac/(number of pt *2)
 $pt_freq = $pt_freq *2;
my $output = "HGMD/data/power_test_pf_dom_$ARGV[0]"."_test_new_ground_truth_new_spec";
my $output1 = "HGMD/data/power_test_pf_dom_$ARGV[0]"."_test_new_ground_truth_new_value_spec";
...
sub bin_test {
my $R_script = "STGD/scripts/R_pt_AD_spec$ARGV[0].R";
my $R_out = "STGD/scripts/R_pt_AD_spec$ARGV[0].out";
